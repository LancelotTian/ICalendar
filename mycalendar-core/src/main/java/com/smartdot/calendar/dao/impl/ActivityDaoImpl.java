...
import com.smartdot.calendar.beans.ActivityMailReminder;
import com.smartdot.calendar.beans.ActivityShare;
import com.smartdot.calendar.beans.ActivitySmsReminder;
...
public class ActivityDaoImpl implements ActivityDao {
	...
	public List getActsByCalid(String calid) throws HibernateException {
		...
		List acts = null;
		Query query = session.createQuery("from com.smartdot.calendar.beans.Activity as entry where entry.srcCalendarId='" + calid + "'");
		acts = query.list();
	...
	public List getShareAcitivitiesInPeriod(String uid, Date startDate, Date endDate) throws HibernateException{
		...
		String hql = "select entry from com.smartdot.calendar.beans.Activity as entry right join entry.activityShare as ashare where ashare.uid='" + uid + "' and ashare.uid <> entry.secid" ;//+searchCondition; 
