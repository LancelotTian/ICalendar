...
public class CalendarServiceImpl implements CalendarService {
    ...
    public boolean deleteCalendar(String cid) {
        ...
        try {
            ...
            String hql = " delete com.smartdot.calendar.beans.ShareCalendar  entry where entry.calendarId='" + cid + "'";


            session.createQuery(hql).executeUpdate();

            SCalendar cal = (SCalendar) session.get("com.smartdot.calendar.beans.SCalendar", cid);
